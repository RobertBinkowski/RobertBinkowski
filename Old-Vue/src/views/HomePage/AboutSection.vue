<template>
  <section id="aboutSection">
    <div>
      ...
      <p>
        Hello, My name is Robert and I love working on new and interesting
        Technologies.<br />
        Ever since my first interaction with Web Development in <em>2017</em>, I
        was intrigued.<br />
        There is always something new and exciting on the horyzon of software
        development.<br />
        Which always pushes me forward to reach new hights.
        <br /><br />
        I always strive to implement new and well implemented coding techniques
        such as
