<template>
  <section id="timelineSection">
    ...
    <div class="experience" v-for="opportunity in timeline" :key="opportunity">
      <a :href="opportunity.link" target="_blank">
        <div>
          <p>
            <img
              :src="opportunity.logo"
              v-show="opportunity.logo"
              :alt="opportunity.name + ' Icon'"
              class="exp-logo"
            /><br />
            <strong>{{ opportunity.role }}</strong
            ><br />
            <em>{{ opportunity.name }} - {{ opportunity.location }}</em
            ><br />
            {{ opportunity.period }}
          </p>
          <br />
          ...
          <div class="grid">
            <em v-for="icon in icons" :key="icon" :class="icon.icon"></em>
          </div>
        </div>
        <div>
          <img
            v-show="opportunity.img"
            :src="opportunity.img"
            :alt="opportunity.name + ' Screenshot'"
            class="exp-screen"
          />
        </div>
      </a>
